...
7/29 24~26行目で添え字をarg-xで表すようにしました。
## 入出力結果
...
## 修正履歴
[comment #20200728]
- まず初めにsscanf関数を用いてターミナルで入力する3つの値を読み込むためのコードを記入してください。
- for文の回数は定数ではなくて、ターミナルで入力した値となるようにしてください。
- 捏造された平均0、分散1の数値に読み取った分散をかけて、読み取った平均を足すとdummyを求める事ができます。
